      ...
      const emailResult = await sendEmail(
        ...
        `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>
              <a href="https://peoplo.redmonk.in/reimbursements" style="display: inline-block; padding: 12px 24px; background-color: #2563eb; color: white; text-decoration: none; border-radius: 6px; font-weight: bold;">View Details</a>
            </p>
